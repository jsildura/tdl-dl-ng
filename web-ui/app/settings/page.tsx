                        ...
                        <div className="space-y-1.5">
                            ...
                            <label className="flex items-center gap-3 cursor-pointer group">
                                <div className="relative flex items-center">
                                    <input
                                        type="checkbox"
                                        checked={settings.download_dolby_atmos}
                                        onChange={(e) => handleChange("download_dolby_atmos", e.target.checked)}
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <span className="text-xs text-on-surface-variant/60">
                                        Downloads the original Atmos stream. Metadata embedding is not supported.
                                    </span>
                                </div>
                            </label>
                            ...
                            <div className="space-y-3 pt-1">
                                ...
                                <label className="flex items-center gap-3 cursor-pointer group">
                                    <div className="relative flex items-center">
                                        <input
                                            type="checkbox"
                                            checked={settings.metadata_genre_lookup}
                                            onChange={(e) => handleChange("metadata_genre_lookup", e.target.checked)}
                                            className="peer h-4.5 w-4.5 cursor-pointer appearance-none rounded-md border-2 border-on-surface-variant transition-all checked:border-primary checked:bg-primary hover:border-primary focus:ring-2 focus:ring-primary/20"
                                        />
                                        <CheckCircle className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-3 h-3 text-on-primary opacity-0 peer-checked:opacity-100 transition-opacity pointer-events-none" />
                                    </div>
                                    <div className="flex flex-col">
                                        <span className="text-sm text-on-surface group-hover:text-primary transition-colors">
                                            Lookup genre from MusicBrainz
                                        </span>
                                        <span className="text-xs text-on-surface-variant/60">
                                            Uses ISRC to fetch genre tags from MusicBrainz database
                                        </span>
                                    </div>
                                </label>
                                ...
                                <div className="space-y-1.5 pt-2">
                                    ...
                                    <div className="relative">
                                        <select
                                            value={settings.metadata_artist_separator}
                                            onChange={(e) => handleChange("metadata_artist_separator", e.target.value as TidalSettings['metadata_artist_separator'])}
                                            className="w-full appearance-none bg-surface-container-high text-on-surface rounded-xl px-3 py-2.5 pr-10 border-none outline-none ring-1 ring-transparent focus:ring-2 focus:ring-primary transition-all duration-200 cursor-pointer text-sm"
                                        >
                                            <option value="; ">Semicolon (Artist1; Artist2)</option>
                                            <option value=", ">Comma (Artist1, Artist2)</option>
                                            <option value=" / ">Slash (Artist1 / Artist2)</option>
                                            <option value=" & ">Ampersand (Artist1 & Artist2)</option>
                                        </select>
                                        <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center px-3 text-on-surface-variant">
                                            <svg className="h-4 w-4 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                                <path d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z" />
                                    ...
                                    <p className="text-xs text-on-surface-variant/60 ml-1">
                                        How multiple artists are separated in metadata tags
                                    </p>
                                </div>
                                ...
                                <label className="flex items-center gap-3 cursor-pointer group">
                                    ...
                                    <div className="flex flex-col">
                                        <span className="text-sm text-on-surface group-hover:text-primary transition-colors">
                                            Multi-thread (Faster Download)
                                        </span>
                                        <span className="text-xs text-on-surface-variant/60">
                                            Downloads segments in parallel. Adds 1.5s delay between tracks to prevent rate limit.
                                        </span>
                                    </div>
                                </label>
                                ...
                                <label className="flex items-center gap-3 cursor-pointer group">
                                    <div className="relative flex items-center">
                                        <input
                                            type="checkbox"
                                            checked={settings.playlist_details_mode}
                                            onChange={(e) => handleChange("playlist_details_mode", e.target.checked)}
                                            className="peer h-4.5 w-4.5 cursor-pointer appearance-none rounded-md border-2 border-on-surface-variant transition-all checked:border-primary checked:bg-primary hover:border-primary focus:ring-2 focus:ring-primary/20"
                                        />
                                        <CheckCircle className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-3 h-3 text-on-primary opacity-0 peer-checked:opacity-100 transition-opacity pointer-events-none" />
                                    </div>
                                    <div className="flex flex-col">
                                        ...
                                        <span className="text-xs text-on-surface-variant/60">
                                            Uses playlist numbering, cover art, and sets Album tag to the playlist name.
                                        </span>
                                    </div>
                                </label>
                            </div>
